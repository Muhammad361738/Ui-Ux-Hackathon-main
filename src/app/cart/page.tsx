...
"use client";
// import MyCart from "../../components/MyCart/Card"
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 flex items-center justify-center md:justify-start gap-2">
                      ...
                      <button
                        ...
                        className="px-3 py-1 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded">                     +                   </button>                 </div>
                    <p className="text-gray-700 font-bold">
                      Total: ${(item.price * item.quantity).toFixed(2)}                 </p>               </div>
                  {/* Remove Button */}
