...
// //               <Image src="/images/sh2.png" alt="image" width={132 } height={129 } className='md:w-[132px] w-[200px] object-cover md:ml-[30px] h-[129px] ' />
// //               <Image src="/images/sh3.png" alt="image" width={132 } height={129 } className='md:w-[132px] w-[200px] object-cover md:ml-[30px] h-[129px] ' />
// //               <Image src="/images/sh4.png" alt="image" width={132 } height={129 } className='md:w-[132px] w-[200px] object-cover md:ml-[30px] h-[129px] ' />
// //               <Image src="/images/sh5.png" alt="image" width={132 } height={129 }  className='md:w-[132px] w-[200px] object-cover md:ml-[30px] h-[129px]  '/>
// //           </div>
// //             <div>
// //             <Image src="/images/sh6.png" alt="image" width={491} height={ 598}  className='md:max-w-[491px] w-[200px] ml-[30px] h-auto mt-[6.25rem] md:h-[598px]'/>
// //           </div>
// //           </div>
// //           {/* right div */}
